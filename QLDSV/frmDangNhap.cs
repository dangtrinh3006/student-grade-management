    ...
    public partial class frmDangNhap : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            if (isSinhVien == false)
            {
                ...
                {
                    MessageBox.Show("Không được để trống tên tài khoản và mật khẩu", "", MessageBoxButtons.OK);
                    return;
                }
            }
            else
            {
                ...
                {
                    MessageBox.Show("Không được để trống tên tài khoản", "", MessageBoxButtons.OK);
                    return;
                }
            }
