...
namespace QLDSV
{
    static class Program
    {
        ...
        public static String connstr_publicsher = "Data Source=DANGTRINH;Initial Catalog=QLDSV;Integrated Security=True";
        ...
        public static int KetNoi()
        {
            if(Program.conn !=null && Program.conn.State == ConnectionState.Open)
                ...
                {
                    MessageBox.Show("Không xác định được tài khoản hoặc sai mật khẩu");
                    return 0;
                }
