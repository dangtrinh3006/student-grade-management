...
namespace QLDSV
{
    public partial class frmDiem : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            if(bdsTemp == null)
            {
                MessageBox.Show("Chưa có dữ liệu để cập nhật điểm!","",MessageBoxButtons.OK);
                return;
            }
            ...
            try
            {
                ...
                for (int i = 0; i < bdsTemp.Count; i++)
                {
                    ...
                    {
                        tran.Rollback();
                        XtraMessageBox.Show("Điểm số nhập phải từ 0 đến 10!");
                        conn.Close();
                        loadBDMH();
                        return;
                    }
            ...
            XtraMessageBox.Show("Cập nhật điểm thành công!", "", MessageBoxButtons.OK);
