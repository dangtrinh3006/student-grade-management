...
namespace QLDSV
{
    public partial class MainForm : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public void MainForm_Load(object sender, EventArgs e)
        {
            ...
            HienThiMenu();
            PhanQuyen();
            this.MANV.Text = "Mã nhân viên: " + Program.username + " |";
            this.HOTEN.Text = "Họ tên: " + Program.mHoten + " |";
            this.NHOM.Text = "Vai trò: " + Program.mGroup;
        }
        ...
        void PhanQuyen()
        {
            if (Program.mGroup.Equals("SV"))
            {
                ...
                DiemButtonItem.Enabled = LopHocbarButton.Enabled = LopTinChibarButton.Enabled = MonHocButtonItem.Enabled = btnSinhVien.Enabled = btnTaoTK.Enabled= false;
